...
function draw() {
  // background(220);
  // frameRate(1);
  draw_head(10+60, 20, [255,255,255,a_alpha]);
  draw_head(10, 80, [255,255,0,a_alpha]);
  draw_head(60-10, 80, [128,128,128,a_alpha]);
  draw_head(110-20, 80, [255,0,0,a_alpha]);
  draw_head(160-30, 80, [0,255,0,a_alpha]);
...
// function draw_head alpha slider
