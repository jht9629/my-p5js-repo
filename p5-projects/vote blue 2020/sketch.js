...
const a_string = 'VOTEBLUE2020';
// const a_string = 'B';

const n_chars = 4;
const n_lines = 3;
let fore_color = [0, 0, 200];
// let back_color = 'white';
let back_color = [200, 200, 0];

let page_pause_frames = 30 * 2;
...
function fill_fore_color() {
  fill(fore_color);
}

function fill_back_color() {
  fill(back_color);
}
